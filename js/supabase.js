...
function settingsToSupabaseRow(settings) {
  return {
    ...
    business_google_rating: settings.business?.googleRating || "5.0",
    business_google_review_count: settings.business?.googleReviewCount || "",
    business_google_rating_label: settings.business?.googleRatingLabel || "Google Maps rating",
